...
def main(payer_folder, max_files=None, save_combined=True, payments_filter=None):
    """
    ...
    Args:
        ...
        payments_filter (str, optional): Semicolon-separated string of payment numbers for filtered markdown
    """
    ...
    try:
        ...
        if results.get('filtered_markdown_file'):
            print(f"   • Filtered EFTs markdown: {results['filtered_markdown_file']}")
        print(f"   • Stats Excel: {results['stats_file']}")
